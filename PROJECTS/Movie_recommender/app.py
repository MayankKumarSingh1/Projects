...
popular_df= pickle.load(open('Movie_recommender/popular.pkl','rb'))
pt= pickle.load(open('Movie_recommender/pt.pkl','rb'))
books= pickle.load(open('Movie_recommender/books.pkl','rb'))
similarity_scores= pickle.load(open('Movie_recommender/similarity_scores.pkl','rb'))
